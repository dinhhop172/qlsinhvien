...
{
   public static function sinhVienThiLai1($sql)
   {
   ...
   public static function diemSinhVienTren1($sql)
   {
      // $sql = "SELECT sinhvien.hoten, monhoc.tenmonhoc, diemthi.diemso, diemthi.lanthi
      // FROM diemthi 
      // JOIN sinhvien ON diemthi.masinhvien=sinhvien.masv
   ...
   public static function diemSinhVienDuoi1($sql)
   {
      // $sql = "SELECT sinhvien.hoten, monhoc.tenmonhoc, diemthi.diemso, diemthi.lanthi
      // FROM diemthi 
      // JOIN sinhvien ON diemthi.masinhvien=sinhvien.masv
   ...
   public static function diemTrungBinh1($sql)
   {
